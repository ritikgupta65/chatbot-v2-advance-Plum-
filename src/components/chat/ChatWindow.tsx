...
const ChatWindow: React.FC<ChatWindowProps> = ({
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="bg-gray-900/50 backdrop-blur-sm border-b border-gray-700 p-3 flex-shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <button onClick={onGoHome} className="p-2 rounded-full hover:bg-white/20 transition-colors mr-3">
              <ArrowLeft className="w-4 h-4 text-gray-300" />
            </button>
            <div className="flex items-center">
              <div className="w-8 h-8 rounded-full overflow-hidden mr-3 shadow-md">
      ...
      {/* Message Area */}
      <div className="flex-1 relative h-full overflow-y-auto p-4 space-y-4 scrollbar-hide">
