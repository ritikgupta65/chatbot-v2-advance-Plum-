...
//     const productRegex = /\*\*Product Name:\*\*\s*(.*?)\s*\n\s*\*\*Description:\*\*\s*(.*?)\s*\n\s*\*\*Price:\*\*\s*₹?([\d.]+)\s*\n\s*\*\*Size:\*\*\s*(.*?)\s*\n\s*\*\*Product URL:\*\*\s*\[.*?\]\((.*?)\)\s*\n\s*\*\*Image URL:\*\*\s*!\[.*?\]\((.*?)\)/g;
...
//       const [fullMatch, title, description, price, size, url, image] = match;
...
//               <p className="text-sm text-white mb-1">{product.price} • {product.size}</p>
//               <a
//                 href={product.url}
//                 target="_blank"
//                 className="mt-2 block w-full text-center1 bg-green-600 hover:bg-green-700 transition text-white rounded-md py-1"
//               >
//                 View Product
//               </a>
//             </div>
...
//             ? 'bg-blue-600/20 backdrop-blur-md border border-blue-400/20 text-white ml-auto'
...
//           {/* Tail */}
//           <div
//             className={`absolute top-4 ${isUser ? 'right-0 translate-x-1' : 'left-0 -translate-x-1'}`}
//           >
//             <div
//               className={`w-3 h-3 rotate-45 ${isUser
//                 ? 'bg-blue-600/20 border-l border-t border-blue-400/20'
